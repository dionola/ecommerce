...
export function ProductFilters({ onFilterChange }: { onFilterChange: (filters: any) => void }) {
      ...
      {isOpen && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8 p-8 bg-secondary animate-in fade-in slide-in-from-top-4 duration-300">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <Input
                ...
                onChange={(e) => onFilterChange({ min_price: Number(e.target.value) })}
              />
              <Input
                type="number"
                placeholder="Max"
          ...
          <div className="space-y-4">
            ...
            <Select onValueChange={(val) => onFilterChange({ sort_by: val })}>
          ...
          <div className="flex items-center gap-4 mt-auto h-12">
            <Switch
              ...
              onCheckedChange={(checked) => onFilterChange({ in_stock: checked })}
            />
