...
const checkCategoryIssues = async () => {
  ...
  try {
    ...
    if (nullCategoryProducts.rows.length > 0) {
      ...
      nullCategoryProducts.rows.slice(0, 20).forEach((product: any) => {
    ...
    if (productsWithEmptyImageArrays.rows.length > 0) {
      ...
      productsWithEmptyImageArrays.rows.slice(0, 20).forEach((product: any) => {
    ...
    if (categoryCaseIssues.rows.length > 0) {
      ...
      categoryCaseIssues.rows.forEach((row: any) => {
