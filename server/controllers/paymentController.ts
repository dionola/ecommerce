...
import { PayRexProcessor } from "../services/payments/payrex/PayRexProcessor";
import {
...
async function createPaymentIntent(req: AuthenticatedRequest, res: Response) {
  ...
  const { getUserIdByCognitoSub } = await import("../services/users/userService");
...
async function confirmPayment(req: AuthenticatedRequest, res: Response) {
  ...
  if (result.status === "succeeded") {
    ...
    const { clearCart } = await import("../services/carts/cartService");
